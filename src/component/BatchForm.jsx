...
// <div className='col-12 col-md-6 b-form mt-5'>
// <h2 className="title m-3" >Create Batch</h2>
//       <form onSubmit={handleSubmit} className='formsy'>
...
//         <label htmlFor="name" style={{color:"white",padding:"10px"}}>Start date</label>
//           <input
//             type="date"
//             className="input form-control"
//             id="startDate"
...
//             }}
//           />
//           {/* <label className="iLabel" htmlFor="startDate"></label> */}
//         </div>
